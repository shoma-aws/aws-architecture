...
![2.ターゲットグループhealthy](./images/2.ターゲットグループhealthy.png)

### EC2の状態（障害前）
![3.EC2の状態](./images/3.EC2の状態.png)

### セキュリティグループ（障害前）
![4.セキュリティグループ](./images/4.セキュリティグループ.png)

### webにアクセスできない
![5.webにアクセスできない](./images/5.webにアクセスできない.png)
ALBのDNS名にアクセスしたが、Webページが表示されなかった

### ALBはアクティブ
![6.ALBはアクティブ](./images/6.ALBはアクティブ.png)
ALB自体はアクティブだった

### ターゲットグループunhealthy
![7.ターゲットグループunhealthy](./images/7.ターゲットグループunhealthy.png)
ALBのTarget Groupを確認したところ、全てのターゲットが Unhealthy となっていた

### EC2はアクティブ
![8.EC2はアクティブ](./images/8.EC2はアクティブ.png)
EC2自体には問題はなかった

### EC2セキュリティグループ
![9.EC2セキュリティグループ](./images/9.EC2セキュリティグループ.png)
EC2のセキュリティグループを見るとALBからのインバウンドルールがなかった

### インバウンドルール追加
![10.インバウンドルール追加](./images/10.インバンドルール追加.png)
